...
# Generated: Mon Mar  2 23:44:16 2015
##################################################
...
class fm_channelizer(gr.top_block, Qt.QWidget):
    ...
    def set_freq_corr(self, freq_corr):
        ...
        self.uhd_usrp_source_0.set_center_freq(self.center_freq + self.freq_corr, 0)
        Qt.QMetaObject.invokeMethod(self._freq_corr_counter, "setValue", Qt.Q_ARG("double", self.freq_corr))
        Qt.QMetaObject.invokeMethod(self._freq_corr_slider, "setValue", Qt.Q_ARG("double", self.freq_corr))
